...
> ✅ **ไม่มี SQL / frontend ค้าง (2026-09-17)** — 0070–0074 รันบน production แล้วทุกไฟล์
> และ push ขึ้น `main` ครบ · ล่าสุด **`8cdb9a6`** (0074 เอกสารแนบรายเครื่อง)
>
...
>
> ⏳ **ยังไม่ได้ทดสอบบน production: การอัปโหลดไฟล์จริงของ 0074** — เดโมป้อนไฟล์เข้า
> `<input type=file>` ไม่ได้ จึงยืนยันได้แค่ UI · เส้นทาง `uploadUnitDoc → signed URL`
> ต้องลองแนบ 1 ไฟล์บนของจริงสักครั้ง (ถ้า bucket ไม่ได้ถูกสร้าง จะ error ตอนอัปโหลด ไม่ใช่ตอนกดปุ่ม)
>
> ---
>
> ### เดิม (2026-08-20)
...
lbs-platform/
  ...
  supabase/
    migrations/0001..0074    schema, RPC, seed, bug fixes, ฟีเจอร์ (ดูตารางหัวข้อ 5)
...
> DB ใหม่บนโปรเจกต์เปล่า: รัน **0001→0074** เรียงกันได้เลย (0004/0005 ผสานเข้า 0001/0002 ต้นทางแล้ว แต่ยังเก็บไฟล์แยกไว้เป็นประวัติ · 0012/0013 ถูก 0014 ยกเลิกแต่ต้องรันเรียงเพราะ 0014 อ้างถึงของที่มันสร้าง — ทุกไฟล์ idempotent รันซ้ำได้)
...
### 🟠 Migrations — ✅ 0070–0074 รันครบ (ยืนยัน 2026-09-15 → 09-17) · ⚠️ 0060–0069 ไม่มีบันทึกยืนยันในเอกสาร
...
> | 0070–0074 | ✅ รันครบ · ผู้ใช้ยืนยันรายไฟล์ตอน push แต่ละรอบ (0070 · 0071 · 0072 · 0073 · 0074) |
>
