...
| Migrations ที่รันแล้ว | **0001–0028** (0027 รัน 2026-07-24 · 0028 รัน 2026-07-24) · ⚠️ **0029 เป็นไฟล์ใหม่ (2026-07-24) ยังไม่รันบน production — ต้องรันก่อน/พร้อม push frontend** ไม่งั้นสร้าง/แก้ Project Stock จะ error (recreate rpc_create/update_project_stock +p_po_no) · ถ้า LINE ไม่ส่ง เช็คตาราง `app_settings` (0017) · อัปโหลดรูปไม่ได้ เช็ค bucket `install-photos` (0019) |
...
lbs-platform/
  ...
  supabase/
    migrations/0001..0029    schema, RPC, seed, bug fixes, ฟีเจอร์
...
> DB ใหม่บนโปรเจกต์เปล่า: รัน 0001→0029 เรียงกันได้เลย (0004/0005 ผสานเข้า 0001/0002 ต้นทางแล้ว แต่ยังเก็บไฟล์แยกไว้เป็นประวัติ · 0012/0013 ถูก 0014 ยกเลิกแต่ต้องรันเรียงเพราะ 0014 อ้างถึงของที่มันสร้าง — ทุกไฟล์ idempotent รันซ้ำได้)
...
### 🟠 Migrations — ✅ 0001–0028 รันครบ (0028 รัน 2026-07-24) · ⏳ 0029 รอรัน (2026-07-24)
- [x] ~~0011–0028~~ รันครบ · **กติกา: หลัง push ไม่ต้องรัน SQL ใดๆ เว้นแต่มี migration ไฟล์ใหม่ (ผมจะบอกชื่อไฟล์)**
- [ ] **รัน `0029_project_stock_po_no.sql`** บน Supabase SQL Editor ก่อน/พร้อม push frontend — idempotent · เพิ่ม `po_no` + recreate rpc_create/update_project_stock · ยังไม่รัน = สร้าง/แก้ Project Stock จะ error
