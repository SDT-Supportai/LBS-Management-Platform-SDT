...
| Migrations ที่รันแล้ว | **0001–0041 รันครบ** (0041 รัน 2026-08-03) · **🆕 0042–0046 รอรัน (รันเรียงลำดับ ก่อน push frontend)** · ถ้า LINE ไม่ส่ง เช็คตาราง `app_settings` (0017) · อัปโหลดรูป/ไฟล์แนบไม่ได้ เช็ค bucket `install-photos` (0019 — ไฟล์แนบปัญหาใช้ bucket เดิม prefix `job-issues/`) |
...
### 🟠 Migrations — ✅ 0001–0041 รันครบ (0041 รัน 2026-08-03) · 🆕 **0042–0046 รอรัน**
- [ ] 🆕 **รัน `0043_lbs_unit_plan.sql` → `0044_job_payments.sql` → `0045_standards.sql` → `0046_std_bom_import.sql`** (เรียงตามลำดับ · ต้องรันก่อน push frontend — 0044 พึ่ง `app_assert_job_cost_editable` ที่ 0042 patch ไว้ ถ้ายังไม่รัน 0042 ให้รันก่อน · 0045+0046 เป็นคู่กัน (0046 พึ่งตาราง/helper ของ 0045) แต่อิสระจาก 0042–0044)
