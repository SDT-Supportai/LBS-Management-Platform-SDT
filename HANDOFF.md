...
**`npm test` ต้องเขียวก่อน commit ทุกครั้ง** — 80 เคส รัน ~1.5 วินาที ไม่ต้องต่อ DB ไม่ต้อง mock
...
| `accStatusLabel` / `accStatusBadge` | คอลัมน์ "สถานะ" ต้อง**ไม่ขัดกับ**คอลัมน์ "เบิกให้ Service" — `AccReqStatus` ไม่ขยับตอนเบิกให้ Service (0059 ใช้ `issuedToServiceAt` แยก) | เจอบนจอ 2026-08-27 |
