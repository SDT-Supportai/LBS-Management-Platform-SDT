...
> ⏳ **ค้าง (2026-09-23): `0078` Standard Drawing แนบ PDF หลายไฟล์ — ยังไม่รัน SQL / ยังไม่ push** · ต้องรัน SQL ก่อน push (โมดัลใหม่เรียก `rpc_save_std_drawing`)
>
...
lbs-platform/
  ...
  supabase/
    migrations/0001..0078    schema, RPC, seed, bug fixes, ฟีเจอร์ (ดูตารางหัวข้อ 5)
...
> DB ใหม่บนโปรเจกต์เปล่า: รัน **0001→0078** เรียงกันได้เลย (0004/0005 ผสานเข้า 0001/0002 ต้นทางแล้ว แต่ยังเก็บไฟล์แยกไว้เป็นประวัติ · 0012/0013 ถูก 0014 ยกเลิกแต่ต้องรันเรียงเพราะ 0014 อ้างถึงของที่มันสร้าง — ทุกไฟล์ idempotent รันซ้ำได้)
